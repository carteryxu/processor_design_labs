    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_pipeline__my_AGEX_stage->varInsert("correct_predictions", &(TOP__pipeline__my_AGEX_stage.correct_predictions), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    __Vscopep_pipeline__my_AGEX_stage->varInsert("total_branches", &(TOP__pipeline__my_AGEX_stage.total_branches), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
