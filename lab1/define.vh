...
// address space is m 0x00000000 to 0x000fffff
  ...
  `define IDMEMINITFILE "/Users/carterxu/Desktop/CS3220/cs3220-labs-sp2026/lab1/test/part1/test4.mem"
...
/** TODO: please update the following define with your own values */ 
 ...
 `define FE_latch_WIDTH  (1 + `INSTBITS+`DBITS+ `DBITS + `DBITS)
  `define DE_latch_WIDTH  (1 + `INSTBITS+`DBITS+`DBITS+ `IOPBITS + `DBITS + `DBITS + `DBITS + `DBITS + 1 + 1 + 1 + 1 + `REGNOBITS)
